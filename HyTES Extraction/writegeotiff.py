...
def writegeotiff(data,lon,lat,fname):
    ...
    #Regrid on a regular grid... - why does this take forever?
...
if __name__ == '__main__':
    raw_hy_dir_path = r'C:\Users\sarp\Documents\sarp_research\data\HyTES-1720801104056zzz' # the directory that contains the hdf5 file, the geo.dat and the geo.hdr.
    hdf_f_path = os.path.join(raw_hy_dir_path,'2015-02-04.211620.ControlledRelease.Line6-Run6-Segment01.L3-CMF.hdf5')
    geo_dat_f_path = os.path.join(raw_hy_dir_path,'2015-02-04.211620.ControlledRelease.Line6-Run6-Segment01-110000-geo.dat')
    geo_hdr_f_path = os.path.join(raw_hy_dir_path,'2015-02-04.211620.ControlledRelease.Line6-Run6-Segment01-110000-geo.hdr')
    ...
    dst_dir = r'C:\Users\sarp\Documents\sarp_research\data\test'
    dst_path = os.path.join(dst_dir,'test_NH3.tif')
